...
const serviceCity = getServiceCityBySlug("seo-services-bangalore")
...
// JSON-LD Schemas for SEO Services Bangalore Page
...
export default function SEOServicesBangalorePage() {
  if (!serviceCity) {
    notFound()
  }
