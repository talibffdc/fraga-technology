...
function IndustrySidebar({ currentSlug }: { currentSlug: string }) {
  ...
  return (
    <div className="sticky top-28">
      ...
      <nav className="flex flex-col gap-1" aria-label="Industry navigation">
      ...
      <div className="mt-8 rounded-xl bg-gradient-to-br from-primary/10 to-accent/10 p-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Get a free consultation for your industry-specific project.
        </p>
        <Link
          href="/#contact"
...
export default function IndustryPageContent({ industry }: { industry: IndustryData }) {
  return (
    <div>
      {/* Hero Banner */}
      <section className="relative overflow-hidden bg-foreground px-6 py-20 lg:px-8 lg:py-28">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <nav className="mb-8 flex items-center gap-2 text-sm" aria-label="Breadcrumb">
            ...
            <ChevronRight className="h-3.5 w-3.5 text-background/30" />
            <span className="font-medium text-background">{industry.title}</span>
          </nav>
          ...
          >
            <span className="text-balance">{industry.tagline}</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section className="px-6 py-16 lg:px-8 lg:py-24">
        <div className="mx-auto flex max-w-7xl gap-12 lg:gap-16">
          ...
          <aside className="hidden w-64 shrink-0 lg:block">
            <IndustrySidebar currentSlug={industry.slug} />
          </aside>
          ...
          <div className="min-w-0 flex-1">
            ...
            >
              <h2 className="font-serif text-3xl font-bold leading-tight text-foreground md:text-4xl">
                <span className="text-balance">Digital Solutions for {industry.title}</span>
              </h2>
            ...
            >
              ...
              <h3 className="mb-8 font-serif text-2xl font-bold text-foreground md:text-3xl">
                <span className="text-balance">Common {industry.title} Marketing Challenges</span>
              </h3>
            ...
            >
              ...
              <h3 className="mb-10 font-serif text-2xl font-bold text-foreground md:text-3xl">
                <span className="text-balance">{industry.title} Services We Offer</span>
              </h3>
            ...
            >
              <h2 className="mb-6 font-serif text-2xl font-bold text-foreground md:text-3xl">
                <span className="text-balance">Results You Can Expect</span>
              </h2>
              <div className="grid gap-4 sm:grid-cols-2">
            ...
            {industry.faqs.length > 0 && (
              ...
              >
                ...
                <h3 className="mb-8 font-serif text-2xl font-bold text-foreground md:text-3xl">
                  {industry.title} Marketing Questions
                </h3>
            ...
            >
              <h2 className="font-serif text-3xl font-bold text-primary-foreground md:text-4xl">
                <span className="text-balance">Ready to Grow Your {industry.title} Business?</span>
              </h2>
              <p className="mx-auto mt-4 max-w-lg text-base text-primary-foreground/80">
                ...
                strategy for your {industry.title.toLowerCase()} company.
              </p>
